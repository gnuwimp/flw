...
private:
    ...
    Fl_Align                    _align;             ///< @brief Text align.
    Fl_Font                     _font;              ///< @brief Text font.
    Fl_Fontsize                 _fontsize;          ///< @brief Text size.
    Fl_PostScript_File_Device*  _printer;           ///< @brief Printer device.
    Fl_Paged_Device::Page_Format _page_format;      ///< @brief Page format.
    Fl_Paged_Device::Page_Layout _page_layout;      ///< @brief Page layout.
    FILE*                       _file;              ///< @brief Postscript file handle.
    bool                        _border;            ///< @brief Border property.
    bool                        _wrap;              ///< @brief Wrap property.
    int                         _lh;                ///< @brief Current line height.
    int                         _line_count;        ///< @brief Line counter.
    int                         _line_num;          ///< @brief Line number width.
    int                         _lw;                ///< @brief Current line width.
    int                         _nw;                ///< @brief Line width if line number is used.
    unsigned                    _page_count;        ///< @brief Page counter.
    int                         _ph;                ///< @brief Page height.
    int                         _pw;                ///< @brief Page width.
    int                         _px;                ///< @brief Page x pos.
    int                         _py;                ///< @brief Page y pos.
    std::string                 _filename;          ///< @brief Postscript filename.
};
