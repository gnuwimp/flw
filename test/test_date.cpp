...
void error() {
    ...
    { // Failure
        ...
        FLW_ASSERT("00010101", date1.format().c_str())
...
void set() {
    ...
    { // Weeks
        date1.set(2004, 2, 29);
        FLW_TRUE(9 == date1.week())
        FLW_TRUE(Date::DAY::SUNDAY == date1.weekday())

        date1.set(2015, 12, 21);
        FLW_TRUE(52 == date1.week())
        FLW_TRUE(Date::DAY::MONDAY == date1.weekday())

        date1.set(2015, 12, 28);
        FLW_TRUE(53 == date1.week())
        FLW_TRUE(Date::DAY::MONDAY == date1.weekday())

        date1.set(2016, 1, 5);
        FLW_TRUE(1 == date1.week())
        FLW_TRUE(Date::DAY::TUESDAY == date1.weekday())
    }
