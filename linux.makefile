# Makefile generated 2021-03-03 19:57:58 from lmake.conf for linux.opt
...
linux.makefile: lmake.conf
	lmake -m linux.makefile -o linux -c lmake.conf -b opt
...
test_chart: obj/test_chart.o obj/libflw.a
	g++ $^ `/usr/local/bin/fltk-config --ldflags` -o $@
